class ApiKeyManager {
    ...
    async handleFormSubmit(e) {
        ...
        if (apiKey.length < 20) {
            alert('A API Key parece ser muito curta. Verifique se você copiou corretamente.');
            return;
        }
        ...
        try {
            ...
            if (isValid) {
                ...
                alert('API Key inválida. Verifique se você copiou corretamente e tente novamente.');
                this.hideLoadingState();
            }
        } catch (error) {
            console.error('Erro ao validar API Key:', error);
            alert('Erro ao validar API Key. Verifique sua conexão e tente novamente.');
            this.hideLoadingState();
        }
    }
